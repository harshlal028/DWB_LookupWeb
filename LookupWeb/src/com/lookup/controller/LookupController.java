...
public class LookupController {
	...
	@RequestMapping(
			...
			consumes = "application/json",
			produces = "application/json")
	public @ResponseBody Places getPlaceDetailByName(
													@RequestBody PlaceName name
													)
	{
	...
	@RequestMapping(
			...
			consumes = "application/json",
			produces = "application/json")
	public @ResponseBody List<Places> getPlaceDetailByCategory(
	 ...
	 */
	@RequestMapping(
			value = "/List/Rating/{rating:.+}",
			method = RequestMethod.POST,
			consumes = "application/json",
			produces = "application/json")
	public @ResponseBody List<Places> getPlaceDetailByRating(
	...
	/**
	 * This function is used to fetch a list of places with rating greater than equal to the given rating.
	 * @param rating
	 * @return
	 */
	@RequestMapping(
			value = "/List/Rating/{rating:.+}/Large",
			method = RequestMethod.POST,
			consumes = "application/json",
			produces = "application/json")
	public @ResponseBody List<Places> getPlaceDetailByRatingLarge(
													@PathVariable("rating") float rating
																)
	{
		logger.info("Rating received for query is "+rating);
	...
	/**
	 * This function is used to fetch a list of places with rating less than or equal to the given rating.
	 * @param rating
	 * @return
	 */
	@RequestMapping(
			value = "/List/Rating/{rating:.+}/Small",
			method = RequestMethod.POST,
			consumes = "application/json",
			produces = "application/json")
	public @ResponseBody List<Places> getPlaceDetailByRatingSmall(
													@PathVariable("rating") float rating
																)
	{
		logger.info("Rating received for query is "+rating);
	...
	/**
	 * This fucntion is used to fetch a list of places based on category and equal to a given rating.
	 * @param category
	 * @param rating
	 * @return
	 */
	@RequestMapping(
			value = "/List/Category/{category}/Rating/{rating:.+}",
			method = RequestMethod.POST,
			consumes = "application/json",
			produces = "application/json")
	public @ResponseBody List<Places> getPlaceDetailByCategoryRating(
														@PathVariable("category") String category,
														@PathVariable("rating") float rating
																	)
	{
	...
	/**
	 * This function is used to fetch a list of places based on category and greater than equal to a given rating.
	 * @param category
	 * @param rating
	 * @return
	 */
	@RequestMapping(
			value = "/List/Category/{category}/Rating/{rating:.+}/Large",
			method = RequestMethod.POST,
			consumes = "application/json",
			produces = "application/json")
	public @ResponseBody List<Places> getPlaceDetailByCategoryRatingLarge(
														@PathVariable("category") String category,
														@PathVariable("rating") float rating
																		)
	{
	...
	/**
	 * This function is used to fetch a list of places based on category and less than equal to a given rating.
	 * @param category
	 * @param rating
	 * @return
	 */
	@RequestMapping(
			value = "/List/Category/{category}/Rating/{rating:.+}/Small",
			method = RequestMethod.POST,
			consumes = "application/json",
			produces = "application/json")
	public @ResponseBody List<Places> getPlaceDetailByCategoryRatingSmall(
													@PathVariable("category") String category,
													@PathVariable("rating") float rating
																		)
	{
	 ...
	 */
	@RequestMapping(
			value = "/List/Lat/{lattitude:.+}",
			method = RequestMethod.POST,
			consumes = "application/json",
			produces = "application/json")
	public @ResponseBody List<Places> getPlaceDetailByLat(
	 ...
	 */
	@RequestMapping(
			value = "/List/Long/{longitude:.+}",
			method = RequestMethod.POST,
			consumes = "application/json",
			produces = "application/json")
	public @ResponseBody List<Places> getPlaceDetailByLong(
	...
	/**
	 * This function is used to fetch a list of places based on lattitude & longitude.
	 * @param category
	 * @return
	 */
	@RequestMapping(
			value = "/List/LatLong/{lattitude:.+}/{longitude:.+}",
			method = RequestMethod.POST,
			consumes = "application/json",
			produces = "application/json")
	public @ResponseBody Places getPlaceDetailByLatLong(
													@PathVariable("lattitude") String lattitude,
													@PathVariable("longitude") String longitude
															)
	{
   ...
   {
   		return respHandle.sendResponse(
   									IResponse.FAILURE,
